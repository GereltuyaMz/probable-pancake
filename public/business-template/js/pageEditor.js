function attachPageListeners() {
  ...
  backGroundImgChoice1.addEventListener("click", function (e) {
    hasBackgroundImg.forEach(function (item) {
      item.style.backgroundImage =
        "url('../business-template/images/pexels-essow-kedelina-936722.jpg')";
    });
  });

  // backGroundImgChoice2.addEventListener("click", function (e) {
  //   hasBackgroundImg.forEach(function (item) {
  //     item.style.backgroundImage = "url('../business-template/images/choice2.jpg')";
  //   });
  // });

  // backGroundImgChoice3.addEventListener("click", function (e) {
  //   hasBackgroundImg.forEach(function (item) {
  //     item.style.backgroundImage = "url('../business-template/images/choice3.jpg')";
  //   });
  // });

  // backGroundImgChoice4.addEventListener("click", function (e) {
  //   hasBackgroundImg.forEach(function (item) {
  //     item.style.backgroundImage = "url('../business-template/images/choice4.jpg')";
  //   });
  // });
  ...
  slider.addEventListener('input', function (e) {
    fontSizeEditor.forEach(function (item) {
      ...
      console.log(item.style.fontSize = newFont + 'px');
